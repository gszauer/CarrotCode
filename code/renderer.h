...
u32 canvas_draw_subtext(canvas* context, font* fnt, const u32_string* text, u32 start_index, u32 length, u32 x, u32 y, u8 r, u8 g, u8 b); // returns width of text drawn (after clipping)
...
u32 font_get_subwidth(font* fnt, const u32_string* text, u32 start_index, u32 length); // Get width of substring
